    ...
    <div>
      ...
      <div className="text-white mt-5 flex justify-center">
        <div className="w-10/12 homeIntro flex rounded-lg p-6">
          <img src="/insideout.jpg" className="h-48 rounded-lg" />
          <div className="flex flex-col pl-4">
            <div className="text-base font-semibold">Inside Out 2</div>
      ...
      <div className="flex justify-center mt-6 text-white">
        <div className="w-10/12 mt-5 text-sm text-justify">
          ...
          {isExpanded && (
            <>
              The plot is compelling and creative, giving both old and new
              emotions their own challenges to overcome. This keeps the audience
              engaged, as each challenge brings about an even greater one, right
              up to the end. There are no easy fixes or solutions, making the
              development of the characters even more rewarding. It is
              refreshing to see how even the emotions themselves have to learn
              new things to move forward.
              <br />
              <br />
